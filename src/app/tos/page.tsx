...
export const metadata: Metadata = {
  title: "ご利用規約 | mizphses.com",
  description: "ご利用規約およびWEB販売規約です。",
};
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <p>
            この利用規約（以下，「本規約」といいます。）は，mizphses.com運営者（以下，「運営者」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
          </p>
          <h2
            className={css({
              fontSize: "24px",
        ...
        >
          ...
          <p>
            この利用規約（以下，「本規約」といいます。）は，mizphses.com運営者（以下，「運営者」といいます。）がこのウェブサイト上で提供するWEB販売サービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。なお、本規定は主たる利用規約のうちWEB販売サービスにのみ適用される個別規約に該当します。
          </p>
          <h2
            className={css({
              fontSize: "24px",
