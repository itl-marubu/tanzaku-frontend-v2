...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "個人情報保護方針と外部送信規律に関する表示です。",
      },
    ],
  }),
  ...
  return (
    <div className="flex h-screen flex-col">
      ...
      <div className="mx-auto w-full max-w-[1200px] p-[13px]">
        ...
        <h2 id="privacy_policy" className={h2Class}>
          個人情報保護方針
        </h2>
        <p>
        ...
        <h2 id="external" className={h2Class}>
          情報の外部送信について
        </h2>
        <p>
        ...
        <ul>
          ...
          <li>
            Google広告オプトアウトページ:{" "}
            <a href="https://adssettings.google.com/anonymous?hl=ja">
