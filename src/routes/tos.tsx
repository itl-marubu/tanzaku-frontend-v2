...
export const Route = createFileRoute("/tos")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "ご利用規約です。" },
    ],
  }),
  component: TosPage,
});

const h2Class = "my-5 text-2xl font-bold";
  ...
  return (
    <div className="flex h-screen flex-col">
      ...
      <div className="mx-auto w-full max-w-[1200px] p-[13px]">
        <h1 className="my-5 text-4xl font-bold">ご利用規約</h1>
        <section className="my-5">
          ...
          <h2 className={h2Class}>第2条（利用登録）</h2>
          <ol>
            <li>
          ...
          <h2 className={h2Class}>第3条（ユーザーIDおよびパスワードの管理）</h2>
          <ol>
            <li>
          ...
          <h2 className={h2Class}>第4条（利用料金および支払方法）</h2>
          <ol>
            <li>
          ...
          <h2 className={h2Class}>第5条（禁止事項）</h2>
          <p>
          ...
          <h2 className={h2Class}>第6条（本サービスの提供の停止等）</h2>
          <ol>
            <li>
          ...
          <h2 className={h2Class}>第7条（利用制限および登録抹消）</h2>
          <ol>
            <li>
          ...
          <h2 className={h2Class}>第8条（退会）</h2>
          <p>
            ユーザーは，運営者の定める退会手続により，本サービスから退会できるものとします。
          </p>
          <h2 className={h2Class}>第9条（保証の否認および免責事項）</h2>
          <ol>
            <li>
          ...
          <h2 className={h2Class}>第10条（サービス内容の変更等）</h2>
          <p>
            運営者は，ユーザーへの事前の告知をもって、本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。
          </p>
          <h2 className={h2Class}>第11条（利用規約の変更）</h2>
          <ol>
            <li>
          ...
          <h2 className={h2Class}>第12条（個人情報の取扱い）</h2>
          <p>
            運営者は，本サービスの利用によって取得する個人情報については，運営者「プライバシーポリシー」に従い適切に取り扱うものとします。
          </p>
          <h2 className={h2Class}>第13条（通知または連絡）</h2>
          <p>
          ...
          <h2 className={h2Class}>第14条（権利義務の譲渡の禁止）</h2>
          <p>
            ユーザーは，運営者の書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。
          </p>
          <h2 className={h2Class}>第15条（準拠法・裁判管轄）</h2>
          <ol>
          ...
          <h2 className={h2Class}>第16条（投稿データの研究利用）</h2>
          <ol>
            <li>
